...
if __name__ == "__main__":
	...
	#TokPort_config_file,TagPort_config_file,LemPort_config_file = load_and_return_config()
	#adverb_norm,number_norm,superlative_norm,augmentative_norm,diminutive_norm,gender_norm,gender_name_norm,verb_norm,ranking,novo_dict = load_and_return_lemmatizer(LemPort_config_file)
	#full_pipe_preload(input_file,TokPort_config_file,TagPort_config_file,LemPort_config_file,adverb_norm,number_norm,superlative_norm,augmentative_norm,diminutive_norm,gender_norm,gender_name_norm,verb_norm,ranking,novo_dict,out_file)
	config_list = load_congif_to_list()
	full_pipe_preload(input_file,config_list,out_file)
